 ...
 * 
 *         1、分析键盘输入样本，1-9分别对应的字母集合，算出分别的概率，可以过滤掉概率很低的数据 2、分析文本记录的样本，分析两个字母之间的前后概率
 *         [aa-az]分别计算出所有的概率，同样可以过滤掉概率比较低的数据 3、用给出的题目进行分析，先套用第一个数字-字母概率集，列出每项可能的集合列表
...
public class QLMInputMethod {
    ...
    public static void main(String[] args) {
        init();
        // 去掉首位数字6
        String[] inputNumbers = new String[] {"3", "5", "7", "5", "3", "5", "4", "8", "6", "4", "3",
                "8", "6", "6", "4", "5", "2", "5", "3", "6", "6", "2", "3"};
