...
/**
 * 借鉴Mongodb的ObjectId的生成： 4byte时间戳 + 3byte机器标识 + 2byte PID + 3byte自增id
 * 
 * 
 ...
 */
public class MongoObjectId implements Comparable<MongoObjectId>, java.io.Serializable {
    ...
    private static final Logger LOGGER = Logger.getLogger("MongoObjectId");
    ...
    public byte[] toByteArray() {
        ...
        bb.putInt(_time);
        System.out.print("time:"+_time+",");
        bb.putInt(_machine);
        System.out.print("machine:"+_machine+",");
        bb.putInt(_inc);
        System.out.println("integer inc:"+_inc);
        return b;
    }
    ...
    public int compareTo(MongoObjectId id) {
        if (id == null)
            return -1;
    ...
    static {
        ...
        try {
            ...
            final int processPiece;
            {
                ...
                ClassLoader loader = MongoObjectId.class.getClassLoader();
    ...
    public boolean equals(Object o) {
        ...
        MongoObjectId that = (MongoObjectId) o;
    ...
    public static void main(String[] args) {
        System.out.println(new MongoObjectId().toHexString());
        System.out.println(new MongoObjectId().toHexString());
        System.out.println(new MongoObjectId().toHexString());
