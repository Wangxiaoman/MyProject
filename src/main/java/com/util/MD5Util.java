...
public class MD5Util {
	...
	public static void main(String[] args) {
		// 字符串加密
		System.out.println(MD5Util.stringToMD5("XX"));
		// 文件加密
		System.out.println(MD5Util.fileNameToMD5("/Users/wangxiaoman/weibo4j.jar"));
		
		System.out.println(MD5Util.fileNameToMD5(new File("/Users/wangxiaoman/weibo4j.jar")));
	}
}
