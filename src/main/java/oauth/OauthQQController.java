...
@Controller
@RequestMapping("/oauth/tencent/")
public class OauthQQController {
	
	@RequestMapping(value="/tologin",produces = "application/text;charset=utf-8")
	public void tologin(HttpServletRequest request,HttpServletResponse response) throws QQConnectException{
	...
	public void afterlogin(Model model,HttpServletRequest request,HttpServletResponse response) throws IOException{
...
//                	out.println(name+",欢迎你，您已经成功登陆!<br/>");
//                	out.println("<a href='http://maslow.cn'>返回</a>");
                	
                	request.getSession().setAttribute("access_nick_name", name);
